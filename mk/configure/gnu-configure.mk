...
CONFIGURE_ARGS+=	--bindir=${GNU_CONFIGURE_PREFIX}/bin${BINARCHSUFFIX}/${GNU_CONFIGURE_LIBSUBDIR}
CONFIGURE_ARGS+=	--sbindir=${GNU_CONFIGURE_PREFIX}/sbin${BINARCHSUFFIX}/${GNU_CONFIGURE_LIBSUBDIR}
.endif
